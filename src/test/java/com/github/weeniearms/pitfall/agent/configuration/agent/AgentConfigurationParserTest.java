package com.github.weeniearms.pitfall.agent.configuration.agent;
...
public class AgentConfigurationParserTest {
    ...
    public void shouldAllValuesBeProvided() throws Exception {
        // given
        System.setProperty(AgentConfigurationParser.CONFIG_FILE_NAME_PROPERTY, "src/test/resources/config-all.yml");
    ...
    public void shouldThrowExceptionForNotProperlyPreparedFile() throws Exception {
        // given
        System.setProperty(AgentConfigurationParser.CONFIG_FILE_NAME_PROPERTY, "src/test/resources/config-empty.yml");
